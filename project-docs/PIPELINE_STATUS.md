...
│ Status: ⏳ NOT STARTED                                          │
│ Progress: 0% (0/42 tasks completed)                            │
...
1. **Quality Gates**: Every task must pass QA validation
2. **Retry Logic**: Maximum 3 attempts per task with specific feedback
3. **Escalation Procedures**: Clear path for blocked or failed tasks
4. **Context Preservation**: Complete information passed between agents
5. **Progress Tracking**: Continuous monitoring of pipeline health
...
- Every task must pass QA validation with EvidenceQA
